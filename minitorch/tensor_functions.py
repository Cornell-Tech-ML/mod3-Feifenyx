...
class Neg(Function):
    ...
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Return the negation function $f(x) = -x$."""
        return t1.f.neg_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Return the negated backpropagated derivative."""
...
class Inv(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Compute the inverse function $f(x) = 1 / x$."""
        ctx.save_for_backward(t1)
        return t1.f.inv_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Compute the gradient of the inverse function using the backpropagated derivative."""
        (t1,) = ctx.saved_values
...
class Add(Function):
    ...
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Return the addition function $f(x, y) = x + y$."""
        return t1.f.add_zip(t1, t2)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Return the gradients of both input tensors based on the backpropagated derivative."""
...
class Mul(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Return the multiplication function $f(x, y) = x * y$."""
...
class Sigmoid(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        r"""Compute the sigmoid function $f(x) = \frac{1.0}{(1.0 + e^{-x})}$ if $x >= 0$ else $\frac{e^x}{(1.0 + e^x)}$."""
        ctx.save_for_backward(t1)
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        return t1.f.mul_zip(
            t1.f.mul_zip(
                sigmoid_t1, t1.f.add_zip(tensor([1.0]), t1.f.neg_map(sigmoid_t1))
            ),
            grad_output,
        )
...
class ReLU(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Compute the ReLU function $f(x) = x$ if $x > 0$ else 0."""
        ctx.save_for_backward(t1)
...
class Log(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Compute the log function $f(x) = log(x)$."""
        ctx.save_for_backward(t1)
...
class Exp(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Compute the exponential function $f(x) = e^x$."""
        ctx.save_for_backward(t1)
...
class Sum(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        """Perform the backward pass for the sum operation."""
...
class IsClose(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Return 1.0 if the difference between `x` and `y` is less than 0.01 else 0.0"""
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        """Rearrange the dimensions of the tensor according to the specified order."""
    ...
    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        """Perform the backward pass for the permute operation, restoring the original order."""
...
class View(Function):
    ...
    def forward(ctx: Context, a: Tensor, shape: Tensor) -> Tensor:
        """Reshape the tensor into a new shape while ensuring it is contiguous."""
...
def grad_central_difference(
    ...
    """Computes the central difference gradient for a given function and input tensor values.
    ...
    ----
        ...
        ind: The index of the input tensor.

    Returns:
    -------
        float: The computed central difference gradient for the specified input tensor.
