...
class TensorData:
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Converts a user-provided index into the corresponding flat index in the storage.

        Parameters
        ----------
        index : Union[int, UserIndex]
            The multi-dimensional index (or a single integer index) to be converted.

        Returns
        -------
        int
            The flat index corresponding to the provided multi-dimensional index.

        Raises
        ------
        IndexingError
            If the index is out of range or its size does not match the shape of the tensor.
    ...
    def indices(self) -> Iterable[UserIndex]:
        """Generate all possible multi-dimensional indices for the current tensor shape."""
    ...
    def get(self, key: UserIndex) -> float:
        """Retrieve the value stored at the specified index in the tensor."""
